...
def print_test(iteration, feed_dict_test, test_loss):
    test_acc = sess.run(accuracy, feed_dict=feed_dict_test)
    print("> iteration: ", iteration, ", test accuracy: ", test_acc, ", test loss: ", test_loss)
...
def optimize(num_iterations):
    ...
    for i in range(total_iterations, total_iterations + num_iterations): # for i in range(total_iterations, total_iterations + num_iterations):
        ...
        test_idx = np.random.randint(X_Test.shape[0], size=test_size)
        ...
        # print_test(i, feed_dict_test, test_loss)

        print("> iteration: ", i, ", test accuracy: ", test_acc_, ", test loss: ", test_loss)

        print(">>> total de ", succ_count, " acertos em ", len(res), " testes. > ", succ_count/len(res))
        ...
        # print_test(epoch, feed_dict_test, test_loss)
